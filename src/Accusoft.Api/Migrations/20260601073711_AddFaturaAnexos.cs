...
{
    /// <inheritdoc />
    public partial class AddFaturaAnexos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_fatura_anexos", x => x.id);
                    table.ForeignKey(
                        name: "FK_fatura_anexos_faturas_fatura_id",
                        column: x => x.fatura_id,
                        principalTable: "faturas",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_fatura_anexos_users_usuario_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_fatura_anexos_fatura_id",
                table: "fatura_anexos",
                column: "fatura_id");

            migrationBuilder.CreateIndex(
                name: "IX_fatura_anexos_usuario_id",
                table: "fatura_anexos",
                column: "usuario_id");
        }
