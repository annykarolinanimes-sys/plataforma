        ...
        [FromQuery] int pageSize = 20)
    {
        ...
        if (!string.IsNullOrWhiteSpace(search))
        {
            ...
            query = query.Where(a =>
                ...
                (a.ClienteContacto != null && a.ClienteContacto.ToLower().Contains(s)) ||
                (a.EnderecoOrigem != null && a.EnderecoOrigem.ToLower().Contains(s)) ||
                (a.EnderecoDestino != null && a.EnderecoDestino.ToLower().Contains(s)) ||
                (a.Status != null && a.Status.ToLower().Contains(s)) ||
                (a.Prioridade != null && a.Prioridade.ToLower().Contains(s)) ||
                (a.Observacoes != null && a.Observacoes.ToLower().Contains(s)) ||
                ...
                (a.Veiculo != null && a.Veiculo.Marca != null && a.Veiculo.Marca.ToLower().Contains(s)) ||
                (a.Veiculo != null && a.Veiculo.Modelo != null && a.Veiculo.Modelo.ToLower().Contains(s)) ||
                (a.Transportadora != null && a.Transportadora.Nome != null && a.Transportadora.Nome.ToLower().Contains(s)) ||
                a.Entregas.Any(e =>
                    (e.Destinatario != null && e.Destinatario.ToLower().Contains(s)) ||
                    (e.Endereco != null && e.Endereco.ToLower().Contains(s)) ||
                    (e.Contacto != null && e.Contacto.ToLower().Contains(s)) ||
                    (e.Observacoes != null && e.Observacoes.ToLower().Contains(s))));
        }
