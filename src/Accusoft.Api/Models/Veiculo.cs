...
public class Veiculo
{
    ...
    /// <summary>Matrícula portuguesa. Formato: AA-00-AA | 00-AA-00 | 00-00-AA.</summary>
    ...
    /// <summary>
    /// Vehicle Identification Number (ISO 3779 / FMVSS 115).
    /// 17 caracteres alfanuméricos; sem I, O ou Q.
    /// Único a nível de base de dados (índice parcial WHERE vin IS NOT NULL).
    /// </summary>
    ...
    /// <summary>
    /// Ficheiros anexos ao veículo (documentos comprovativos de troca de
    /// matrícula, inspeções, seguros, etc.).
    /// </summary>
