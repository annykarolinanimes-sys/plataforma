...
// DTO de criação - ATENÇÃO: Propriedades em PascalCase para corresponder ao C#
export interface GuiaCreateDto {
  Tipo: string;                    // PascalCase
  AtribuicaoId?: number;           // PascalCase
  ClienteId?: number;              // PascalCase
  TransportadoraId?: number;       // PascalCase
  EnderecoOrigem?: string;         // PascalCase
  EnderecoDestino?: string;        // PascalCase
  DataPrevistaEntrega?: string;    // PascalCase
  Observacoes?: string;            // PascalCase
  InstrucoesEspeciais?: string;    // PascalCase
  Itens: GuiaItemCreateDto[];      // PascalCase
}

export interface GuiaItemCreateDto {
  ProdutoId: number;               // PascalCase
  Quantidade: number;              // PascalCase
  Lote?: string;                   // PascalCase
  Observacoes?: string;            // PascalCase
}
